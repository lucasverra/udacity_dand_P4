...
Yes, We created a new variable that 'merges' the information contained in housing and loan variables. The objective is to have one variable that aggregate the binari condition of having a loan.  
...
So we observe that there is a correlation (but negative one!), the more contacts (calls) a client has the less he is willing to convert (Y variable value 'yes')
